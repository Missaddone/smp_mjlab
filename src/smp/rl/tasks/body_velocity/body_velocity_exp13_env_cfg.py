...
_FOOT_TILT_CONTACT_THRESHOLD = 80.0
_FOOT_TILT_WEIGHT = -0.05
...
def _foot_tilt_80_specs() -> tuple[Exp13BodyVelocityGroupSpec, ...]:
  specs: list[Exp13BodyVelocityGroupSpec] = []
  for group, parent_group in enumerate((4, 5, 6), start=19):
    ...
    specs.append(
      Exp13BodyVelocityGroupSpec(
        ...
        base_exp10_group=parent.base_exp10_group,
        reward=parent.reward,
        foot_tilt_weight=_FOOT_TILT_WEIGHT,
        foot_tilt_contact_threshold=_FOOT_TILT_CONTACT_THRESHOLD,
        persistent_single_support_weight=0.0,
        finetune_parent_group=parent.group,
        run_name=(
...
_FOOT_TILT_80_GROUP_SPECS = _foot_tilt_80_specs()

EXP13_BODY_VELOCITY_GROUP_SPECS = (
  _BASE_GROUP_SPECS
  + _FINETUNE_GROUP_SPECS
  + _FOOT_TILT_80_GROUP_SPECS
)
