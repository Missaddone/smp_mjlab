"""Experiment 6 group 11 forward config: zero + walking/running bins."""
...
def g1_forward_exp6_group11_smp_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
