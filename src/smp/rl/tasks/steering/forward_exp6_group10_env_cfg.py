"""Experiment 6 group 10 forward config: zero + walking/running bins."""
...
def g1_forward_exp6_group10_smp_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  cfg = g1_forward_smp_env_cfg(play=play)
  command = cfg.commands["steering"]
  command.tar_speed_min = 1.5
  command.tar_speed_max = 5.0
  command.zero_speed_prob = 0.3
  command.low_speed_prob = 0.35
